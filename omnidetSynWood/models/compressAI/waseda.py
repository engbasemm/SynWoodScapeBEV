...
from .priors import JointAutoregressiveHierarchicalPriors , ScaleHyperpriorDecoder , JointAutoregressiveHierarchicalPriorsDecoder
...
class Cheng2020Anchor(JointAutoregressiveHierarchicalPriors):
    ...
    def __init__(self, N=192, **kwargs):
        ...
        self.g_a = nn.Sequential(
            ResidualBlockWithStride(3, N, stride=2 , padding = 1),
            ResidualBlock(N, N),
            ResidualBlockWithStride(N, N, stride=2),
            ResidualBlock(N, N),
            ResidualBlockWithStride(N, N, stride=2),
            ResidualBlock(N, N, padding=1),
            conv3x3(N, N, stride=2 , padding=1)
        )
...
class Cheng2020AttentionDecoder(JointAutoregressiveHierarchicalPriorsDecoder):
    """Self-attention model variant from `"Learned Image Compression with
    Discretized Gaussian Mixture Likelihoods and Attention Modules"
    <https://arxiv.org/abs/2001.01568>`_, by Zhengxue Cheng, Heming Sun, Masaru
    Takeuchi, Jiro Katto.
