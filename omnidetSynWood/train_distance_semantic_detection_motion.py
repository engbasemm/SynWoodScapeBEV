...
class DistanceSemanticDetectionMotionModel(DistanceSemanticDetectionModelBase, DistanceSemanticMotionModelBase):
    ...
    def distance_semantic_detection_motion_train(self):
        ...
        for self.epoch in range(self.args.epochs):
            ...
            for batch_idx, inputs in enumerate(self.train_loader):
                ...
                outputs, losses = self.distance_semantic_detection_motion_loss_predictions(inputs , mode='val')
    ...
    def distance_semantic_detection_motion_loss_predictions(self, inputs, mode='train'):
        features, outputs, losses = self.distance_semantic_motion_loss_predictions(inputs, mode)
