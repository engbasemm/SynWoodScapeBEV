...
class TrainUtils:
    ...
    def configure_compression_optimizers(self):
        self.optimizer  = torch.optim.SGD(self.parameters_to_train, self.args.learning_rate)
        self.lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(self.optimizer, self.args.scheduler_step_size)
...
class IoU:
    ...
    def __init__(self, num_classes, dataset, ignore_index=None):
        ...
        self.classes = dict(synwoodscape_raw=["void", "road", "lanemarks", "curb", "person",
